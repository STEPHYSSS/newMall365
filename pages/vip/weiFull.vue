<template>
	<div class="weiFull" :class="mainStyle">
		...
		<div class="btnfixedBottom" v-if="!loading">
			<button :disabled="btnLoading" class="buttonPage" type="redRaduis" @click="clickSubmit(true)" :loading="btnLoading" :class="{ active: isActive }">充值</button>
		</div>
		<uni-popup type="bottom" ref="popup" @change="changePopup">
			<div class="popup-income">
				...
				<div class="button-theme-big">
					<button :disabled="btnLoading" @click="clickSubmit(false)" :loading="btnLoading" :class="{ active: isActive }">立即充值</button>
				</div>
			</div>
		</uni-popup>
	</div>
