<template>
	<view class="">
		<uni-nav-bar :status-bar="true" @clickLeft="clickLeft" title="活动助力" :shadow="false" :fixed="true" left-icon="back"></uni-nav-bar>
		...
		<!-- 		<image src="https://img-shop.qmimg.cn/s16/images/2020/04/27/ca59f6bbbb830a16.png"></image>
			...
			<image src='https://img-shop.qmimg.cn/s16/images/2020/04/27/ca59f6bbbb830a16.png'  style="width: 100%;" mode="widthFix"></image>
