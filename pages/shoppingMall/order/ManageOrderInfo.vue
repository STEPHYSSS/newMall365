<template>
	<div :class="['order-info-style',classHome]">
		<uni-nav-bar v-if="!showArea" :fixed="true" title="订单详情" :status-bar="true" :shadow="false"></uni-nav-bar>
		<div v-if="!loading&&OrderInfo.SID">
			<div class="order-area-fa" v-if="JSON.stringify(currentArea) !== '{}'&&OrderInfo.OrderType!=='1'&&OrderInfo.OrderType!='3'">
