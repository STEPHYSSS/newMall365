<template>
	<view class="uni-numbox">
		...
		<view class="uni-numbox__value" @click.stop="">{{inputValue}}</view>
		<!-- <input :disabled="disabled" @blur="_onBlur" @click.stop="" class="uni-numbox__value" type="number" v-model="inputValue" /> -->
