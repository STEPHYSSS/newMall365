...
export function GetAppNo() { //获取商户编号
	if (window.location.hostname == "localhost" || window.location.hostname == "wx8d4708e1e9895e87.manage.bak365.cn") {
...
export function setUrlDelCode() {
	...
	// console.log(arrUrl,'split--arrUrl')
	var para = arrUrl[1];
	// console.log(para,'para下标1')
	if (para.indexOf('&')) {
